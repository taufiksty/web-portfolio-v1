		...
		<section
			...
			<div className="mt-5 lg:flex lg:gap-20">
				...
				<div className="flex flex-col justify-center items-center space-y-5 text-center w-2/3 aspect-square mx-auto ">
					...
					<p className="font-inter text-[14px] dark:text-white leading-6">
						Develop and maintain your websites while ensuring optimal
						performance and traffic capacity with expertise in both Front-End &
						Back-End.
					</p>
				</div>
				{/* </FrontEndBackEnd> */}
				...
				<div className="flex flex-col justify-center items-center space-y-5 text-center w-2/3 aspect-square mx-auto ">
					...
					<p className="font-inter text-[14px] dark:text-white leading-6">
						Create and maintain your websites, ensuring seamless integration
						with databases, while optimizing performance and traffic capacity
						with expertise in Front-End, Back-End, and Database management.
					</p>
				</div>
				{/* </Database> */}
			</div>
